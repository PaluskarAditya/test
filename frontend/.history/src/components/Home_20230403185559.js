...
export default function Home() {
  ...
  const links = [{name: "Swiggy", img: "https://d3.harvard.edu/platform-digit/wp-content/uploads/sites/2/2020/03/1_Qw11nbTP2pBb08x-H2WDSA.png"}]
        ...
        <div className="reach-overlay">
          ...
          <div className="links">
            {links.map(item => <div className='link-card'>
              ...
              <h2 className='item-name'>{item.name}</h3>
              <button>visit</button>
            </div>)}
          </div>
        </div>
